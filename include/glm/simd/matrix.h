...
GLM_FUNC_QUALIFIER glm_vec4 glm_mat4_determinant_lowp(glm_vec4 const m[4]) {
  ...
  //SubFactor02), 	- (m[1][0] * SubFactor00 - m[1][2] * SubFactor03 +
  //m[1][3] * SubFactor04), 	+ (m[1][0] * SubFactor01 - m[1][1] * SubFactor03
  //+ m[1][3] * SubFactor05), 	- (m[1][0] * SubFactor02 - m[1][1] * SubFactor04
  //+ m[1][2] * SubFactor05));
